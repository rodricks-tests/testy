...
export default function Home() {
  ...
  return (
    <div className=" bg-cover bg-center text-foreground py-16 flex items-center flex-col w-full h-full gap-4 scrollbar-hidden">
      ...
      <ColorPalette />
      <ProductForm />
      <Button hoverLabel="this is label"> this is the button </Button>
      <Button variant="secondary"> this is the button </Button>
      <Button hoverLabel="this is label" variant="primaryPlane"> this is the button </Button>
      <Button variant="neutral"> this is the button </Button>
      <Bids />
      <MyProducts/>
