...
Vite is opinionated and comes with sensible defaults out of the box. Vite has a rich ecosystem of plugins to support fast refresh, JSX,  Babel/SWC, and other common features. See Vite’s[link](https://vite.dev/plugins/#vitejs-plugin-react)[React plugin](https://vite.dev/plugins/#vitejs-plugin-react) or[link](https://vite.dev/plugins/#vitejs-plugin-react-swc)[React SWC plugin](https://vite.dev/plugins/#vitejs-plugin-react-swc) and[link](https://vite.dev/guide/ssr.html#example-projects)[React SSR example project](https://vite.dev/guide/ssr.html#example-projects) to get started.
Vite is already being used as a build tool in one of our[link](https://react.dev/learn/creating-a-react-app)[recommended frameworks](https://react.dev/learn/creating-a-react-app):[link](https://reactrouter.com/start/framework/installation)[React Router](https://reactrouter.com/start/framework/installation).
### **Parcel **
...
Parcel supports fast refresh, JSX, TypeScript, Flow, and styling out of the box. See[link](https://parceljs.org/recipes/react/#getting-started)[Parcel’s React recipe](https://parceljs.org/recipes/react/#getting-started) to get started.
### **Rsbuild **
...
Rsbuild includes built-in support for React features like fast refresh, JSX, TypeScript, and styling. See[link](https://rsbuild.dev/guide/framework/react)[Rsbuild’s React guide](https://rsbuild.dev/guide/framework/react) to get started.
### **Note**
#### **Metro for React Native **
If you’re starting from scratch with React Native you’ll need to use[link](https://metrobundler.dev/)[Metro](https://metrobundler.dev/), the JavaScript bundler for React Native. Metro supports bundling for platforms like iOS and Android, but lacks many features when compared to the tools here. We recommend starting with Vite, Parcel, or Rsbuild unless your project requires React Native support.
...
Similarly, if you rely on the apps using your framework to split the code, you might encounter situations where loading becomes slower than if no code splitting were happening at all. For example,[link](https://react.dev/reference/react/lazy)[lazily loading](https://react.dev/reference/react/lazy) a chart delays sending the code needed to render the chart, splitting the chart code from the rest of the app.[link](https://parceljs.org/recipes/react/#code-splitting)[Parcel supports code splitting with React.lazy](https://parceljs.org/recipes/react/#code-splitting). However, if the chart loads its data *after* it has been initially rendered you are now waiting twice. This is a waterfall: rather than fetching the data for the chart and sending the code to render it simultaneously, you must wait for each step to complete one after the other.
...
Since the build tool you select only supports single page apps (SPAs), you’ll need to implement other[link](https://www.patterns.dev/vanilla/rendering-patterns)[rendering patterns](https://www.patterns.dev/vanilla/rendering-patterns) like server-side rendering (SSR), static site generation (SSG), and/or React Server Components (RSC). Even if you don’t need these features at first, in the future there may be some routes that would benefit SSR, SSG or RSC.
...
If you don’t want to solve these problems on your own, you can[link](https://react.dev/learn/creating-a-react-app)[get started with a framework](https://react.dev/learn/creating-a-react-app) that provides these features out of the box.
