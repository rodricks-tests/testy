# **prerender**
prerender renders a React tree to a static HTML string using a[link](https://developer.mozilla.org/en-US/docs/Web/API/Streams_API)[Web Stream](https://developer.mozilla.org/en-US/docs/Web/API/Streams_API).
...
### **Note**
This API depends on[link](https://developer.mozilla.org/en-US/docs/Web/API/Streams_API)[Web Streams.](https://developer.mozilla.org/en-US/docs/Web/API/Streams_API) For Node.js, use[link](https://react.dev/reference/react-dom/static/prerenderToNodeStream)[prerenderToNodeStream](https://react.dev/reference/react-dom/static/prerenderToNodeStream) instead.
## **Reference **
...
Call prerender to render your React tree to static HTML into a[link](https://developer.mozilla.org/en-US/docs/Web/API/ReadableStream)[Readable Web Stream:](https://developer.mozilla.org/en-US/docs/Web/API/ReadableStream):
import { prerender } from 'react-dom/static';
async function handler(request) {
const {prelude} = await prerender(<App />, {
bootstrapScripts: ['/main.js']
...
To stream content as it loads, use a streaming server render API like[link](https://react.dev/reference/react-dom/server/renderToReadableStream)[renderToReadableStream](https://react.dev/reference/react-dom/server/renderToReadableStream).
