...
- [Reference](https://react.dev/reference/react-compiler/directives/use-no-memo#reference)
  ...
  - [How](https://react.dev/reference/react-compiler/directives/use-no-memo#how-use-no-memo-opts-out)["use no memo"](https://react.dev/reference/react-compiler/directives/use-no-memo#how-use-no-memo-opts-out)[opts-out of optimization](https://react.dev/reference/react-compiler/directives/use-no-memo#how-use-no-memo-opts-out)
  - [When to use](https://react.dev/reference/react-compiler/directives/use-no-memo#when-to-use)["use no memo"](https://react.dev/reference/react-compiler/directives/use-no-memo#when-to-use)
