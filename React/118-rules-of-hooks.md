...
Functions whose names start with use are called[link](https://react.dev/reference/react)[*Hooks*](https://react.dev/reference/react) in React.
...
You can use the[link](https://www.npmjs.com/package/eslint-plugin-react-hooks)[eslint-plugin-react-hooks](https://www.npmjs.com/package/eslint-plugin-react-hooks)[plugin](https://www.npmjs.com/package/eslint-plugin-react-hooks) to catch these mistakes.
### **Note**
...
✅ Call Hooks from[link](https://react.dev/learn/reusing-logic-with-custom-hooks#extracting-your-own-custom-hook-from-a-component)[custom Hooks](https://react.dev/learn/reusing-logic-with-custom-hooks#extracting-your-own-custom-hook-from-a-component).
