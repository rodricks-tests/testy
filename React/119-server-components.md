...
Server Components are for use in[link](https://react.dev/learn/start-a-new-react-project#full-stack-frameworks)[React Server Components](https://react.dev/learn/start-a-new-react-project#full-stack-frameworks).
...
See[link](https://react.dev/reference/rsc/server-components#async-components-with-server-components)[Async components with Server Components](https://react.dev/reference/rsc/server-components#async-components-with-server-components) below.
...
For more info, see the docs for[link](https://react.dev/reference/rsc/directives)[Directives](https://react.dev/reference/rsc/directives).
