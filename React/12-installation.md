...
## **Prerequisites **
React Compiler is designed to work best with React 19, but it also supports React 17 and 18. Learn more about[link](https://react.dev/reference/react-compiler/target)[React version compatibility](https://react.dev/reference/react-compiler/target).
### **Note**
...
## **Basic Setup **
React Compiler is designed to work by default without any configuration. However, if you need to configure it in special circumstances (for example, to target React versions below 19), refer to the[link](https://react.dev/reference/react-compiler/configuration)[compiler options reference](https://react.dev/reference/react-compiler/configuration).
...
### **Next.js **
Please refer to the[link](https://nextjs.org/docs/app/api-reference/next-config-js/reactCompiler)[Next.js docs](https://nextjs.org/docs/app/api-reference/next-config-js/reactCompiler) for more information.
### **React Router **
...
### **Webpack **
A community webpack loader is[link](https://github.com/SukkaW/react-compiler-webpack)[now available here](https://github.com/SukkaW/react-compiler-webpack).
### **Expo **
Please refer to[link](https://docs.expo.dev/guides/react-compiler/)[Expo’s docs](https://docs.expo.dev/guides/react-compiler/) to enable and use the React Compiler in Expo apps.
### **Metro (React Native) **
React Native uses Babel via Metro, so refer to the[link](https://react.dev/learn/react-compiler/installation#babel)[Usage with Babel](https://react.dev/learn/react-compiler/installation#babel) section for installation instructions.
### **Rspack **
Please refer to[link](https://rspack.dev/guide/tech/react#react-compiler)[Rspack’s docs](https://rspack.dev/guide/tech/react#react-compiler) to enable and use the React Compiler in Rspack apps.
### **Rsbuild **
Please refer to[link](https://rsbuild.dev/guide/framework/react#react-compiler)[Rsbuild’s docs](https://rsbuild.dev/guide/framework/react#react-compiler) to enable and use the React Compiler in Rsbuild apps.
## **ESLint Integration **
...
If you haven’t already configured eslint-plugin-react-hooks, follow the[link](https://github.com/facebook/react/blob/main/packages/eslint-plugin-react-hooks/README.md#installation)[installation instructions in the readme](https://github.com/facebook/react/blob/main/packages/eslint-plugin-react-hooks/README.md#installation). The compiler rule is enabled by default in the latest RC, so no additional configuration is needed.
...
1. Look for the ✨ emoji next to component names
...
For more troubleshooting help, see the[link](https://react.dev/learn/react-compiler/debugging)[debugging guide](https://react.dev/learn/react-compiler/debugging).
## **Next Steps **
