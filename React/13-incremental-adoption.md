...
1. **Opt-in with “use memo”** - Only compile components that explicitly opt in
1. **Runtime gating** - Control compilation with feature flags
...
1. Check the [debugging guide](https://react.dev/learn/react-compiler/debugging) for common issues
1. Fix Rules of React violations identified by the ESLint plugin
1. Consider using compilationMode: 'annotation' for more gradual adoption
## **Next Steps **
