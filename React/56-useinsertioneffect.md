# **useInsertionEffect**
### **Pitfall**
useInsertionEffect is for CSS-in-JS library authors. Unless you are working on a CSS-in-JS library and need a place to inject the styles, you probably want[link](https://react.dev/reference/react/useEffect)[useEffect](https://react.dev/reference/react/useEffect) or[link](https://react.dev/reference/react/useLayoutEffect)[useLayoutEffect](https://react.dev/reference/react/useLayoutEffect) instead.
