# **useReducer**
useReducer is a React Hook that lets you add a[link](https://react.dev/learn/extracting-state-logic-into-a-reducer)[reducer](https://react.dev/learn/extracting-state-logic-into-a-reducer) to your component.
...
- [Reference](https://react.dev/reference/react/useReducer#reference)
  ...
  - [dispatch](https://react.dev/reference/react/useReducer#dispatch)[function](https://react.dev/reference/react/useReducer#dispatch)
...
Call useReducer at the top level of your component to manage its state with a[link](https://react.dev/learn/extracting-state-logic-into-a-reducer)[reducer.](https://react.dev/learn/extracting-state-logic-into-a-reducer)
...
1. The [dispatch](https://react.dev/reference/react/useReducer#dispatch)[function](https://react.dev/reference/react/useReducer#dispatch) that lets you update the state to a different value and trigger a re-render.
#### **Caveats **
...
#### **Caveats **
- The dispatch function **only updates the state variable for the *****next***** render**. If you read the state variable after calling the dispatch function,[link](https://react.dev/reference/react/useReducer#ive-dispatched-an-action-but-logging-gives-me-the-old-state-value)[you will still get the old value](https://react.dev/reference/react/useReducer#ive-dispatched-an-action-but-logging-gives-me-the-old-state-value) that was on the screen before your call.
- If the new value you provide is identical to the current state, as determined by an[link](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/is)[Object.is](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/is) comparison, React will **skip re-rendering the component and its children.** This is an optimization. React may still need to call your component before ignoring the result, but it shouldn’t affect your code.
...
Call useReducer at the top level of your component to manage state with a[link](https://react.dev/learn/extracting-state-logic-into-a-reducer)[reducer.](https://react.dev/learn/extracting-state-logic-into-a-reducer)
import { useReducer } from 'react';
function reducer(state, action) {
// ...
}
...
1. The dispatch function that lets you change it in response to interaction.
...
Show more
useReducer is very similar to[link](https://react.dev/reference/react/useState)[useState](https://react.dev/reference/react/useState), but it lets you move the state update logic from event handlers into a single function outside of your component. Read more about[link](https://react.dev/learn/extracting-state-logic-into-a-reducer#comparing-usestate-and-usereducer)[choosing between](https://react.dev/learn/extracting-state-logic-into-a-reducer#comparing-usestate-and-usereducer)[useState](https://react.dev/learn/extracting-state-logic-into-a-reducer#comparing-usestate-and-usereducer)[and](https://react.dev/learn/extracting-state-logic-into-a-reducer#comparing-usestate-and-usereducer)[useReducer](https://react.dev/learn/extracting-state-logic-into-a-reducer#comparing-usestate-and-usereducer)[.](https://react.dev/learn/extracting-state-logic-into-a-reducer#comparing-usestate-and-usereducer)
### **Writing the reducer function **
A reducer function is declared like this:
function reducer(state, action) {
// ...
}
Then you need to fill in the code that will calculate and return the next state. By convention, it is common to write it as a[link](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/switch)[switch](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/switch)[statement.](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/switch) For each case in the switch, calculate and return some next state.
function reducer(state, action) {
switch (action.type) {
...
// ...
The action type names are local to your component.[link](https://react.dev/learn/extracting-state-logic-into-a-reducer#writing-reducers-well)[Each action describes a single interaction, even if that leads to multiple changes in data.](https://react.dev/learn/extracting-state-logic-into-a-reducer#writing-reducers-well) The shape of the state is arbitrary, but usually it’ll be an object or an array.
Read[link](https://react.dev/learn/extracting-state-logic-into-a-reducer)[extracting state logic into a reducer](https://react.dev/learn/extracting-state-logic-into-a-reducer) to learn more.
### **Pitfall**
...
This is because[link](https://react.dev/learn/state-as-a-snapshot)[states behaves like a snapshot.](https://react.dev/learn/state-as-a-snapshot) Updating state requests another render with the new state value, but does not affect the state JavaScript variable in your already-running event handler.
...
You mutated an existing state object and returned it, so React ignored the update. To fix this, you need to ensure that you’re always[link](https://react.dev/learn/updating-objects-in-state)[updating objects in state](https://react.dev/learn/updating-objects-in-state) and[link](https://react.dev/learn/updating-arrays-in-state)[updating arrays in state](https://react.dev/learn/updating-arrays-in-state) instead of mutating them:
function reducer(state, action) {
switch (action.type) {
case 'incremented_age': {
...
In[link](https://react.dev/reference/react/StrictMode)[Strict Mode](https://react.dev/reference/react/StrictMode), React will call your reducer and initializer functions twice. This shouldn’t break your code.
...
Because React calls your reducer function twice, you’ll see the todo was added twice, so you’ll know that there is a mistake. In this example, you can fix the mistake by[link](https://react.dev/learn/updating-arrays-in-state#adding-to-an-array)[replacing the array instead of mutating it](https://react.dev/learn/updating-arrays-in-state#adding-to-an-array):
function reducer(state, action) {
switch (action.type) {
case 'added_todo': {
