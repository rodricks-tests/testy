...
This makes sure your CSS is as small as possible, and is also what makes features like  possible.
...
If you need to scan any files that Tailwind is ignoring by default, you can  those sources.
...
The source input is , so you can generate multiple classes at once. For example, to generate all the red background colors with hover variants, use a range:
CSS
@import "tailwindcss";
