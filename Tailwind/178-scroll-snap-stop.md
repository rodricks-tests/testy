...
Use the snap-always utility together with the  utility to force a snap container to always stop on an element before the user can continue scrolling to the next item:
