...
Use the flow-root utility to create a block-level element with its own :
...
To visually hide an element but keep it in the document, use the  property instead.
